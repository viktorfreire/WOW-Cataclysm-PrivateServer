 ...
 *
 * $Id: jquery.validate.js 5762 2008-07-03 11:47:51Z joern.zaefferer $
 *
...
$.extend($.validator, {
	...
	messages: {
		...
		remote: "Acomode este Campo.",
		email: "Introduzca un eMail Valido.",
		url: "Introduzca un URL Valido.",
		...
		phone: "Introduzca un Telefono Valido.",
		cedula: "Introduzca una Cedula Valida.",
		equalTo: "Repita el Valor Introducido.",
		accept: "Please enter a value with a valid extension.",
		maxlength: $.format("No Escriba mas de {0} Caracteres."),
		minlength: $.format("No Escriba Menos de {0} Caracteres."),
	...
	methods: {
		...
		// Función para validar un numero telefonico en Venezuela
		phone: function(value, element){
			if(value.length < 13){
				return (false);
			}else{
				var parentesis1 = value.substr(0, 1);
				var codigo_area = value.substr(1, 4);
				var parentesis2 = value.substr(5, 1);
				var numero_telf = value.substr(6, 7);
				
				codigo_area = parseInt(codigo_area);
				numero_telf = parseInt(numero_telf);
				
				if ( isNaN(codigo_area) || isNaN(numero_telf) || parentesis1 != '(' || parentesis2 != ')' ) {
					return (false);
				}else{
					return (true);
				} 
		...
		// Funcion que permite validar una cedula en venezuela
		cedula: function(value, element){
			if(value.length < 10 || value == '' || value == null || value == 'undefined' || (value.substr(0,2) != 'V-' && value.substr(0,2) != 'J-')){
				return (false);	
			}else{
				return (true);
			}
